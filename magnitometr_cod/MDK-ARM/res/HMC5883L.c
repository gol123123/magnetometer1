...
{
    v.XAxis = HMC5883L_readRegister16(HMC5883L_REG_OUT_X_L) - xOffset;
    v.YAxis = HMC5883L_readRegister16(HMC5883L_REG_OUT_Y_L) - yOffset;
    v.ZAxis = HMC5883L_readRegister16(HMC5883L_REG_OUT_Z_L);
